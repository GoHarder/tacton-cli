 ...
 */
lib.fromObj = (fileObj) => {
   const { version, namedDomains, componentClasses, rootParts, collections, applications, includes } = fileObj;
   const { identification, model } = lib.tcxTemplate['model-data'];

   if (version) {
      identification['xml-version'] = version;
   }
